	...
	public ActiveDOMObject {
		...
		public: 
			...
			PassRefPtr<WebCLProgram> createProgramWithSource(WebCLContext*, 
					const String&);
			long buildProgram(WebCLProgram*, int, int, int);

			String getProgramBuildInfo(WebCLProgram*, WebCLDeviceIDList*, int);
			...
			long setKernelArg(WebCLKernel*, unsigned int, WebCLMem*);
			//long setKernelArgGlobal(WebCLKernel*, unsigned int, WebCLMem*);
			long setKernelArg(WebCLKernel*, unsigned int, int);
			long setKernelArgFloat(WebCLKernel*, unsigned int, float);
			long setKernelArgConstant(WebCLKernel*, unsigned int, WebCLMem*);
			long setKernelArgLocal(WebCLKernel*, unsigned int,unsigned int);
			...
			//long finish(WebCLCommandQueue*, int, int);
			void finish(WebCLCommandQueue*, PassRefPtr<WebCLFinishCallback>, int /*object userData*/);

			long releaseMemObject(WebCLMem*);
			long releaseProgram(WebCLProgram*);
			//sujit added 23-6-2011
			long releaseEvent(WebCLEvent*);
			//sujit added 23-6-2011
			long releaseSampler(WebCLSampler*);
			//sujit added 23-6-2011
			long retainKernel(WebCLKernel*);
			//sujit added 23-6-2011
			long retainProgram(WebCLProgram*);
			//sujit added 23-6-2011
			long retainEvent(WebCLEvent*);
			//sujit added 23-6-2011
			long retainContext(WebCLContext*);
			//sujit added 23-6-2011
			long retainCommandQueue(WebCLCommandQueue*);
			//sujit added 23-6-2011
			long retainSampler(WebCLSampler*);
			//sujit added 23-6-2011
			long retainMemObject(WebCLMem*);
			long releaseKernel(WebCLKernel*);
			long releaseCommandQueue(WebCLCommandQueue*);
			long releaseContext(WebCLContext*);
			...
			long enqueueAcquireGLObjects(WebCLCommandQueue*, WebCLMem*, int);
			long enqueueReleaseGLObjects(WebCLCommandQueue*, WebCLMem*, int);

			long enqueueCopyBuffer(WebCLCommandQueue*, WebCLMem*, WebCLMem*, int);

			long enqueueBarrier(WebCLCommandQueue*);
		...
		private:
			...
			RefPtr<WebCLPlatformIDList> m_platform_id;
